...
function setInit() {
    if (ocx) {
        ...
        cleanUpCode();
        showCode("html Code:");
        showCode('&lt;object id="ocx" style="width:100%;height: 100%; " classid="CLSID:3556A474-8B23-496F-9E5D-38F7B74654F4" codebase="/ivs_bs_demo/ocx/IVS_OCX.cab#version=2.2.0.1"&gt; &lt;/object&gt;');
        showCode("  ");
