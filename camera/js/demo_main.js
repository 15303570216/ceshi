...
function changePage(pageNo) {
    $('.page-tab-box-but').removeClass("page-tab-box-but-active");
...
function jumpTab(pageNo) {
    $(".div_page").eq(pageNo - 1).addClass('div_page_show');
    $('.page-tab-box-but').eq(pageNo - 1).addClass('page-tab-box-but-active');
    if(pageNo==2){
        app1.getPollingList();
    }
